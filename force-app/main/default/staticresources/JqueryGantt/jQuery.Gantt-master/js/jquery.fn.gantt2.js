        ...
        */
        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                $.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage && i < (element.pageNum * settings.itemsPerPage + settings.itemsPerPage)) {
                        entries.push('<div class="row name row' + i + (entry.desc ? '' : ' fn-wide') + '" id="rowheader' + i + '" offset="' + i % settings.itemsPerPage * tools.getCellWidth() + '">');
            ...
            rightPanel: function (element, leftPanel /* <- never used? */) {
                ...
                switch (settings.scale) {
                    ...
                    case "hours":
                        ...
                        for (var i = 0, len = range.length; i < len; i++) {
                            ...
                            if (rm !== month) {
                                monthArr.push(
                                    ...
                                    + tools.getCellWidth() * daysInMonth + 'px"><div class="fn-label">'
                            ...
                            if (rgetDay !== getDay) {
                                ...
                                dayArr.push('<div class="row date ' + day_class2 + '" '
                                        + ' style="width: ' + tools.getCellWidth() * hoursInDay + 'px;"> '
                            ...
                            horArr.push('<div class="row day '
                                    ...
                                    + '" id="dh-'
                                    + rday.getTime()
                                    + '"  offset="' + i * tools.getCellWidth() + '" repdate="' + rday.getRepDate() + '"><div class="fn-label">'
                                    + rday.getHours()
                                    + '</div></div>');
                        }
                        ...
                        yearArr.push(
                            '<div class="row header year" style="width: '
                            + tools.getCellWidth() * daysInYear + 'px;"><div class="fn-label">'
                            + year
                            + '</div></div>');
                        ...
                        var dataPanel = core.dataPanel(element, range.length * tools.getCellWidth());
                    ...
                    case "weeks":
                        ...
                        for (var i = 0, len = range.length; i < len; i++) {
                            ...
                            if (rday.getMonth() !== month) {
                                monthArr.push(
                                    ('<div class="row header month" style="width:'
                                       + tools.getCellWidth() * daysInMonth
                                       + 'px;"><div class="fn-label">'
                                       + settings.months[month]
                                       + '</div></div>'));
                                month = rday.getMonth();
                            ...
                            dayArr.push('<div class="row day wd" '
                                    + ' id="' + rday.getWeekId() + '" offset="' + i * tools.getCellWidth() + '" repdate="' + rday.getRepDate() + '"> '
                                    + ' <div class="fn-label">' + rday.toDateString() + '</div></div>');
                        }
                    ...
                    case 'months':
                        ...
                        for (var i = 0, len = range.length; i < len; i++) {
                            ...
                            daysInYear++;
                            monthArr.push('<div class="row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellWidth() + '" repdate="' + rday.getRepDate() + '">' + (1 + rday.getMonth()) + '</div>');
                        }
                    ...
                    default:
                        ...
                        for (var i = 0, len = range.length; i < len; i++) {
                            ...
                            dayArr.push('<div class="row date ' + day_class + '" '
                                    + ' id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellWidth() + '" repdate="' + rday.getRepDate() + '"> '
                        ...
                        .append($('<div class="nav-slider" />')
                            .append($('<div class="nav-slider-left" />')
                                ...
                                .append($('<button type="button" class="nav-link nav-prev-week"/>')
                                    ...
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                                            core.navigateTo(element, tools.getCellWidth() * 8);
                                        } else if (settings.scale === 'days') {
                                            core.navigateTo(element, tools.getCellWidth() * 30);
                                        } else if (settings.scale === 'weeks') {
                                            core.navigateTo(element, tools.getCellWidth() * 12);
                                        } else if (settings.scale === 'months') {
                                            core.navigateTo(element, tools.getCellWidth() * 6);
                                        }
                                    }))
                                .append($('<button type="button" class="nav-link nav-prev-day"/>')
                                    ...
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                                            core.navigateTo(element, tools.getCellWidth() * 4);
                                        } else if (settings.scale === 'days') {
                                            core.navigateTo(element, tools.getCellWidth() * 7);
                                        } else if (settings.scale === 'weeks') {
                                            core.navigateTo(element, tools.getCellWidth() * 4);
                                        } else if (settings.scale === 'months') {
                                            core.navigateTo(element, tools.getCellWidth() * 3);
                                        }
                                    })))
                ...
                // Button navigation is provided by setting `settings.navigation='buttons'`
                    ...
                    ganttNavigate = $('<div class="navigate" />')
                        ...
                        .append($('<button type="button" class="nav-link nav-prev-day"/>')
                            .html('&lt;')
                            .click(function () {
                                core.navigateTo(element, tools.getCellWidth());
                            }))
                        .append($('<button type="button" class="nav-link nav-now"/>')
                            .html('&#9679;')
                            .click(function () {
                        ...
                        .append($('<button type="button" class="nav-link nav-next-day"/>')
                            .html('&gt;')
                            .click(function () {
                                core.navigateTo(element, tools.getCellWidth() * -1);
                            }))
                        .append($('<button type="button" class="nav-link nav-next-week"/>')
                            .html('&gt;&gt;')
                            .click(function () {
            ...
            createProgressBar: function (days, cls, desc, label, dataObj) {
                var cellWidth = tools.getCellWidth();
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            switch (settings.scale) {
                                ...
                                case "hours":
                                    ...
                                    var dl = Math.floor((cTo - cFrom) / tools.getCellWidth()) + 1;
                                    ...
                                    var top = tools.getCellWidth() * 5 + 2 + parseInt(topEl.attr("offset"), 10);
                                ...
                                case "weeks":
                                    ...
                                    var dl = Math.round((cTo - cFrom) / tools.getCellWidth()) + 1;
                                    ...
                                    var top = tools.getCellWidth() * 3 + 2 + parseInt(topEl.attr("offset"), 10);
                                    _bar.css({ 'top': top, 'left': Math.floor(cFrom) });
                                ...
                                case "months":
                                    ...
                                    var top = tools.getCellWidth() * 2 + 2 + parseInt(topEl.attr("offset"), 10);
                                    _bar.css({ 'top': top, 'left': Math.floor(cFrom) });
                                ...
                                default:
                                    ...
                                    var top = tools.getCellWidth() * 4 + 2 + parseInt(topEl.attr("offset"), 10);
                                    _bar.css({ 'top': top, 'left': Math.floor(cFrom) });
        ...
        var tools = {
            ...
            getCellWidth: function () {
                if (!tools._getCellWidth) {
         
                    $("body").append(
                        $('<div style="display: none; position: absolute;" class="fn-gantt" id="measureCellWidth"><div class="row"></div></div>')
                    );
                    tools._getCellWidth = $("#measureCellWidth .row").width();
                    $("#measureCellWidth").empty().remove();
                    tools._getCellWidth = 124;
                }
                console.log(tools._getCellWidth);
                return tools._getCellWidth;
            },
            ...
            getPageHeight: function (element) {
                return element.pageNum + 1 === element.pageCount ? element.rowsOnLastPage * tools.getCellWidth() : settings.itemsPerPage * tools.getCellWidth();
            },
